...
This mimics manual download and conversion to `.fst` files (as one might do for setting up a new data source manually). Upon successful set-up, data can be loaded as:
